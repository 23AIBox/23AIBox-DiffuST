...
class DDIMSampler(object):
    def __init__(self, model,diffusion,device, num_timesteps,schedule="linear", **kwargs):
        super().__init__()
        self.model = model
    ...
    def stochastic_encode(self, x0, t, use_original_steps=False, noise=None):
        ...
        return (extract_into_tensor(sqrt_alphas_cumprod.to(self.device), t, x0.shape) * x0 +
                extract_into_tensor(sqrt_one_minus_alphas_cumprod.to(self.device), t, x0.shape) * noise)
